...
namespace CyberPW.Assistant2
{
    ...
    internal sealed class SimulatorPage : UserControl, IModulePage
    {
        ...
        {
            BackColor = Theme.Ink; BackgroundImage = AssetImages.Load("summer","simulator.jpg"); BackgroundImageLayout = ImageLayout.Stretch; drops=JsonFiles.Read<List<Drop>>(System.IO.Path.Combine(AppPaths.Data,"chest-drops.json"));
