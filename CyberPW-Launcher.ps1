...
$form.Text='CyberPW Assistant 1.06 Beta';$form.FormBorderStyle='None';$form.Size='1280,800';$form.MinimumSize='1080,720'
...
$version=New-Label '1.06 β' 64 148 102 26 9 $goldSoft 'Bold';$version.TextAlign='MiddleCenter';$version.BackColor=$jade3;Set-Rounded $version 8
...
$heroStats=New-Label "TITULHELPER: $done / $total     ●  ГОТОВО     VERSION 1.06 BETA" 38 204 510 28 9 $cyan 'Bold'
